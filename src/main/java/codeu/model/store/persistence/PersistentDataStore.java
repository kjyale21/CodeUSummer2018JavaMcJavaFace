...
public class PersistentDataStore {
  ...
  public List<User> loadUsers() throws PersistentDataStoreException {
    ...
    for (Entity entity : results.asIterable()) {
      try {
        ...
        String profilePicLink = (String) entity.getProperty("fb");
        String about = (String) entity.getProperty("bio");
        String status = (String) entity.getProperty("status");
        User user = new User(uuid, userName, passwordHash, creationTime, profilePicLink, about, status);
        users.add(user);
      } catch (Exception e) {
  ...
  public List<Activity> loadActivities() throws PersistentDataStoreException {
    ...
    for (Entity entity : results.asIterable()) {
      try {
        ...
        Instant creation = Instant.parse((String) entity.getProperty("creation_time"));
        String description = (String) entity.getProperty("description");
        Activity activity = new Activity(uuid, title, type, description, creation);
  ...
  public void writeThrough(Activity activity) {
      ...
      activityEntity.setProperty("type", activity.getTypeString());
